...
void desenha_coracao(int indices[], int tamanho, int r, int g, int b) {
...
void desenha_coracao_pulsante(int indices[], int tamanho, int r, int g, int b, int pulsos, int delay_ms) {
