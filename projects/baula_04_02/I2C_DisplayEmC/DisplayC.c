...
int main()
{
  ...
  while (true)
  {
    ...
    ssd1306_draw_string(&ssd, "QWERTYUIOPASDF", 8, 10); // Desenha uma string
    ssd1306_draw_string(&ssd, "GHJKLZXCVBNM", 20, 30); // Desenha uma string
    ssd1306_draw_string(&ssd, "123456789", 15, 48); // Desenha uma string      
