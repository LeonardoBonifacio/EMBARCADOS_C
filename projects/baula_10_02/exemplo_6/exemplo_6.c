...
#define LED_BLUE_PIN 12  // Define o pino GP11 para o LED azul (PWM)
#define LED_GREEN_PIN 11 // Define o pino GP13 para o LED verde (PWM)
#define BUTTON_A_PIN 5   // Define o pino GP5 para o botão A da BitDogLab
#define BUTTON_B_PIN 6   // Define o pino GP6 para o botão B da BitDogLab
